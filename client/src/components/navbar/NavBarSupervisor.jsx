...
export default function NavBarSupervisor({ userData, show, setShow }) {
  return (
    <>
      {userData ? (
        <li className="flex flex-col items-center gap-1 font-['nunito']">
          ...
          <Link
            ...
            to={`/supervisor/${userData}/profile`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
          ...
          <Link
            className="flex w-full my-2"
            to={`/supervisor/${userData}/employees`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
          ...
          <Link
            className="flex w-full my-2"
            to={`/supervisor/${userData}/environment`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
          ...
          <Link
            className="flex w-full my-2"
            to={`/supervisor/${userData}/reports/sender`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
          ...
          <Link
            className="flex w-full my-2"
            to={`/supervisor/${userData}/reports/receiver`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
