                    ...
                    <ul className={`${show ? '' : 'translate-x-[97%]'} ease-in-out transition duration-700`}>
                      {/* <li className='flex flex-col gap-1'> */}
                        ...
                        <a className={`flex w-full my-2 mt-52 ${role === 'guard' ? 'ml-3' : ''}`}>
                          <div onClick={handleRedirectLogOut} className="flex focus:text-[#0023c4] hover:text-[#0023c4] cursor-pointer focus:outline-none font-['nunito'] font-extrabold text-[#ff5cf4]">
