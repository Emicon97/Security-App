...
if(isNaN(Number(dni)) || dni.length<8 || dni.length>8){
    errors.dniFormat = "El formato debe ser de 8 numeros";
}
if(isNaN(Number(phoneNumber))){
    errors.phoneIsNan = "Alguno de los valores no es un número";
}
if(!regexImage.test(image)){
    errors.image = "La imagen acepta formatos jpg, jpeg, gif y png";
}
